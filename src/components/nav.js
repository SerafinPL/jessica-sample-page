...
const NavBar = () => 
(<header class="flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-white text-sm py-4  radius70">
  <nav class="max-w-[85rem] w-full mx-auto px-4 flex flex-wrap basis-full items-center justify-between radius70" aria-label="Global">
    <a class="sm:order-1 flex-none text-xl font-semibold " href="#">Brand</a>
